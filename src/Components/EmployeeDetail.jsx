...
const getSingleemployee = async () => {
    ...
    const  data  = await axios.get(`http://192.168.100.18:8000/api/employe/${email}/`,config)
    console.log(data);
...
const deleteData = async () => {
    ...
    await axios.delete(`http://192.168.100.18:8000/api/employe/${email}/`,config)
...
<Link className="btn btn-primary mr-5" to="/admin" style={{fontSize:'20px'}}>Back</Link> <>
</>
