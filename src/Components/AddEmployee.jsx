...
if(token == null)  {
  ...
  const addNewEmployee = async () => {
    ...
    const response = await axios.post('http://192.168.100.18:8000/api/employe/',formField,config)
  ...
  {/* {
    auth === true ? <Login /> : ( */}
      ...
      <><button style={{margin:'20px'}} className="btn btn-primary btn-block" onClick={addNewEmployee}>Add Employee</button>
      </><></>
      <><Link className="btn btn-primary " to="/admin" style={{fontSize:'16px',height:"37px"}}>Back</Link> 
</>
