...
export default function SigninoutFinal() {
  ...
  async function login(e) {
    ...
    try {
      ...
      const response = await axios.post(
        "http://192.168.100.18:8000/api/emplogin/",
        {
          employe_id: emp_id,
  ...
  return (
    <div>
      ...
      <center>
        <img
          src="/assets/img/baboolsoftLogo.png"
          alt=" BaboolsoftLogo"
          style={{ width: "80px", height: "70px", marginTop: "50px" }}
        />
        <br />
        <img
          src="/assets/img/baboolsoftLogo1.png"
          alt=" BaboolsoftLogo"
      ...
      <Row>
        ...
        <Col>
          ...
          >
            <Card.Body>
              <center>
                <h1 style={{ color: "#119311", marginTop: "35px" }}>
                  Sign Out
                </h1>
                <br />
                <p style={{}}>Employee</p>
