...
export default class Login extends Component {
  ...
  async submitForm(e) {
    ...
    const response = await axios.post(
      "http://192.168.100.18:8000/api/get-token/",
      {
        username: username,
        password: password,
      }
  ...
  render() {
    ...
    return (
      <>
        ...
        <Row>
          <Col sm={2}>
            <img src="./assets/img/baboolsoft.png" />
          </Col>
          <Col sm={10}>
            <Navbar
              className="color-nav"
              style={{ backgroundColor: "#119311" }}
            >
              <Container>
                <Link
                  style={{
                ...
                <Container>
                  <div className="login">
                    <form onSubmit={this.submitForm} className="login_form">
                      <img
                        style={{ width: "155px", marginLeft: "85px" }}
                        src="./assets/img/baboologo.png"
                      />
